...
if (!isset($_SESSION['login'])) {
    if ($_GET['p'] !== null && $_GET['aksi'] !== null && $_['id_buku'] !== null) {
        header("Location: login.php?redirect=$_SERVER[REQUEST_URI]&p=$_GET[p]&aksi=$_GET[aksi]&id_buku=$_GET[id_buku]");
        exit;
    } else {
...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="index.php">Perpustakaan Daerah </a>
    ...
    <div id="layoutSidenav">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <?php if ($_SESSION['login']['level'] == 'admin') { ?>
                            ...
                            <a class="nav-link" href="?p=kontak">
        ...
        <div id="layoutSidenav_content">
            <main>
                <marquee behavior="scroll" class="btn btn-dark">Selamat Datang <b><?= $_SESSION['login']['nama']; ?></b> Perpustakaan Daerah Kabupaten Dairi</marquee>
                <div class="container-fluid">
                    ...
                    if ($page == 'buku') {
                        ...
                        if ($aksi == '') {
                            require_once 'page/kontak/kontak.php';
                        } else if ($aksi == 'hapus') {
                            require_once 'page/kontak/hapus.php';
                        }
                    } else if ($page == 'transaksi') {
                        if ($aksi == '') {
                        ...
                        if ($aksi == '') {
                            ...
                            require_once 'page/user/hapus.php';
                        }
                    } else { ?>
                        <h1 class="mt-4">Dashboard</h1>
                        <ol class="breadcrumb mb-4">
                            <!-- <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li> -->
                            <li class="breadcrumb-item active">Selamat Datang di Perpustakaan Daerah Kabupaten Dairi</li>
                        </ol>
                    <?php } ?>
